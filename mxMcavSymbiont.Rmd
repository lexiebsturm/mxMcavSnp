...
ggsave("./figures/fig1.png", plot = mxMap, width = 25, height = 20, units = "cm", dpi = 600)
```
...
ggsave("./figures/fig2.png", plot = mxSnpPcoaPlot, height = 5, width = 7, units = "in", dpi = 300)
```
...
ggsave("./figures/fig3.png", plot = snpHeatmap, width = 35, height = 15, units = "cm", dpi = 300)
```
...
ggsave("./figures/fig6.png", plot = mxZooxPcoaPlot, height = 5, width = 7, units = "in", dpi = 300)
```